    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          '<button class="btn btn-info edit-note-btn" style="float:right;"><a href="edit-note-page.html" style="display:inline;color: white;text-decoration: none;">编辑笔记</a></button>' +
          '<div class="user-info">' +
          '<div class="user-avatar">' +
          '<a href="personal-page.html" target="_blank"><img src="' + data[i].userAvatar + '" alt="用户头像-sm" class="avatar-sm"></a>' +
          ' <a href="personal-page.html" class="user-name" target="_blank">' + data[i].userName + '</a>' +
